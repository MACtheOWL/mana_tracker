...
class PoolScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Spend button sizing
    const double spendBtnW = 98;
    const double spendBtnH = 46;
...
children: [
  ...
  const SizedBox(height: 14),
                  ...
                  _SectionCard(
                    child: Wrap(
                      ...
                      children: [
                        _spendButton(state, ManaColor.w, _mana(W).bg, spendBtnW, spendBtnH),
                        _spendButton(state, ManaColor.u, _mana(U).bg, spendBtnW, spendBtnH),
                        _spendButton(state, ManaColor.b, _mana(B).bg, spendBtnW, spendBtnH),
                        _spendButton(state, ManaColor.r, _mana(R).bg, spendBtnW, spendBtnH),
                        _spendButton(state, ManaColor.g, _mana(G).bg, spendBtnW, spendBtnH),
                        _spendButton(state, ManaColor.c, _mana(C).bg, spendBtnW, spendBtnH),
                      ],
                    ),
                  ),
  ...
  static Color _fgFor(Color bg) {
    ...
    return lum < 0.45 ? Colors.white : Colors.black;
  }
